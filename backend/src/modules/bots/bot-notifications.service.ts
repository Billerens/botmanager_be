...
`;
  ...
  private formatPermissions(
    ...
    const entityLabels: Record<BotEntity, string> = {
      ...
      [BotEntity.PRODUCTS]: "Товары",
      [BotEntity.CATEGORIES]: "Категории",
      [BotEntity.ORDERS]: "Заказы",
      [BotEntity.CARTS]: "Корзины",
      [BotEntity.SPECIALISTS]: "Специалисты",
      [BotEntity.BOOKINGS]: "Записи",
